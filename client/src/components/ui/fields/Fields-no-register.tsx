			...
			<div className='relative mb-4'>
				...
				<div className='relative'>
					...
					<input
						type={type}
						id={name}
						className='w-full bg-white rounded border border-gray-300 text-base outline-none text-gray-700 py-1 px-3 pl-10 leading-8 transition-colors duration-200 ease-in-out'
						required={isRequired}
