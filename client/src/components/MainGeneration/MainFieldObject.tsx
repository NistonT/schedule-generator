...
import { ISchedule, TypeTeachers } from "@/types/schedule.types";
import { useAtom } from "jotai";
import { m } from "motion/react";
import { useEffect, useState } from "react";

export const EnumTypeFieldObject = {
	Teachers: "Teachers",
} as const;

export type EnumTypeField =
	(typeof EnumTypeFieldObject)[keyof typeof EnumTypeFieldObject];
...
export const MainFieldObject = ({ title, field }: Props) => {
	...
	const [fields, setField] = useState<TypeTeachers[]>([]);
